...
[Bookworm Light](https://astro.build/themes/details/bookworm-light-astro/) has integrated in a local search capability.

This makes it easy for site users to quickly find content that might be useful to them.
